...
if (mtext1?.object3D.visible) mtext1.object3D.visible = false;
var mtext2 = document.querySelector("#mText2");
if (mtext2?.object3D.visible) mtext2.object3D.visible = false;
var mtext3 = document.querySelector("#mText3");
if (mtext3?.object3D.visible) mtext3.object3D.visible = false;
var fText1 = document.querySelector("#fText1");
if (fText1?.object3D.visible) fText1.object3D.visible = false;
